                    ...
                    <form class="col-md-6 userForm" method="post">
                        <div class="py-1">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="tennd" name="tennguoidung" placeholder="" value="<?php echo $row["tennguoidung"]; ?>">
                                <label for="tennd">Tên người dùng :</label>
                            </div>
                        </div>
                        <div class="py-1">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="sdt" name="sdt" placeholder="" value="<?php echo $row["sdt"]; ?>">
                                <label for="sdt">Số điện thoại :</label>
                            </div>
                        </div>
                        <div class="py-1">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="diachi" name="diachi" placeholder="" value="<?php echo $row["diachi"]; ?>">
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col"><a href="profile.php"><button type="button" class="btn">quay lại</button></a></div>
                        </div>
