                    ...
                    <div class="py-3">
                        <div class="d-flex">
                            ...
                            <form class="d-flex col-md-4 " action="editproduct.php" method="POST">
                                <input type="text" class="form-control" name="edit" placeholder="Nhập tên sản phẩm muốn chỉnh sửa" required>
                                <button class="btn btn-primary" style="width: 20%;" type="submit" name="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
                            </form>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td style="width: 4%;"><button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#<?= $row["masp"] ?>">+</button></td>
                                            </tr>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" action="../admin/xulyadmin.php">
                                                                <div class="mb-3">
                                                                    <input type="hidden" class="form-control" name="tensp" value="<?= $row["tensp"] ?>">
                                                                    <label for="update" class="col-form-label">Số lượng hiện tại:<?= $row["soluong"] ?></label>
                                                                    <input type="number" class="form-control" id="update" name="update" placeholder="nhập số lượng mới">
                                                                </div>
