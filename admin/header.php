        ...
        <div class="row">
            ...
            <div class="col-md-5  ">
                <form class="d-flex " action="result.php" method="POST">
                    <input type="text" class="form-control" name="keyword" placeholder="Nhập tên sản phẩm muốn tìm kiếm" required>
                    ...
                    <div class="col">
                        <div class="row">
                            ...
                            <div class="col-9">
                                ...
                                <?php
                                $kh = "";
                                if ($_SESSION["khachhang"] != null && $_SESSION["quantri"] == 1)
                                    $kh = "../user/profile.php";
            ...
            <div class="col-md-2 ">
                <div class="row">
                    ...
                    <div class="col">
                        <a class="position-relative" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <button class="btn btn-primary" type="submit" name="view">Đánh dấu là đã đọc.</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
