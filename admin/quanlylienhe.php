                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?= $row["email"] ?></td>
                                                <td><?= $row["noidung"] ?></td>
                                                <td><button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#b<?= $row["stt"] ?>"><?= $row["trangthai"] ?></button></td>
                                            </tr>
                                            <div class="modal fade" id="b<?= $row["stt"] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Cập nhật trạng thái xử lý liên hệ</h1>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form method="POST" action="../admin/xulyadmin.php">
                                                                <input type="hidden" name="stt" value="<?= $row["stt"] ?>">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="trangthai" id="flexRadio1" value="Đã tiếp nhận" checked>
                                                                    <label class="form-check-label" for="flexRadio1">
                                                                        Đã tiếp nhận
                                                                    </label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="trangthai" id="flexRadio2" value="Đang xử lý">
                                                                    <label class="form-check-label" for="flexRadio2">
                                                                        Đang xử lý
                                                                    </label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="trangthai" id="flexRadio3" value="Đã xử lý">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <div class="col"><button type="submit" class="btn btn-primary" name="contact">xác nhận</button></div>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
