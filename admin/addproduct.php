                ...
                <form class="col-md-6 userForm" method="post">
                    ...
                    <div class="py-1">
                        <div class="form-floating">
                            <select class="form-select" id="loaisp" name="loaisp" required>
                                ...
                                ?>
                                        <option value="<?= $row['loaisp'] ?>"><?= $row['loaisp'] ?>-Mã sản phẩm chung: "<?= $row['masp'] ?>"</option>
                                <?php
                                    }
                                }
                                ?>
                    ...
                    <div class="py-1">
                        <div class="form-floating mb-3">
                            <input type="text" style="text-transform: uppercase;" class="form-control" id="masp" name="masp" placeholder="" required>
                    ...
                    <div class="py-1">
                        <div class="form-floating mb-3">
                            <textarea type="text" class="form-control " id="info" name="info" placeholder="" style="height: 100px;" required></textarea>
                    ...
                    <div class="py-1">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="soluong" name="soluong" placeholder="" required>
                    ...
                    <div class="row pt-3">
                        ...
                        <div class="col"><a href="index.php"><button type="button" class="btn">quay lại</button></a></div>
                    </div>
                </form>
            </div>
        </div>
