                    ...
                    <div class="tab-content py-3" id="myTabContent">
                        <div class="d-flex">
                            ...
                            <form class="d-flex col-md-4 " action="editnews.php" method="POST">
                                <input type="text" class="form-control" name="edit" placeholder="Nhập tên bài viết muốn chỉnh sửa" required>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?= $row["taikhoan"] ?></td>
                                                <td><button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#d<?= $row["mabaiviet"] ?>">Xóa</button></td>
                                            </tr>
                                            <div class="modal fade" id="d<?= $row["mabaiviet"] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" action="../admin/xulyadmin.php">
                                                                <div class="mb-3">
                                                                    <input type="hidden" class="form-control" id="idn" name="idn" value="<?= $row["mabaiviet"] ?>">
                                                                    <p>LƯU Ý: Sau khi xóa tài khoản mọi thông tin về bài viết sẽ biến mất và không thể khổi phục</p>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <div class="col"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button></div>
                                                                    <div class="col"><button type="submit" class="btn btn-danger" name="deletenews">Xóa</button></div>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
