                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="giamgia" aria-describedby="basic-addon1" required>
                                    </div>
                                </div>
                                <div class="col">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                ?>
                                                    <td><button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#sale<?= $row["stt"] ?>">kết thúc</button></td>
                                                <?php } ?>

                                            </tr>
                                            <div class="modal fade" id="sale<?= $row["stt"] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" action="../admin/xulyadmin.php">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <div class="col"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">quay lại</button></div>
                                                                    <div class="col"><button type="submit" class="btn btn-success" name="closesale">Dừng</button></div>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
