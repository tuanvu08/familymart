                ...
                <nav class="navbar navbar-expand-lg ">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        ?>
                                        <li><a class="dropdown-item " href="../product.php?id=<?= $row["loaisp"] ?>"><?= $row["loaisp"] ?></a></li>
                                        <?php
                                            }
                                        }
                                        ?>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="#">phụ kiện otô, xe máy</a></li>
                            ...
                            <div class="col-md-1">
                                <a class="alink" href="logout.php"><button class="btn btn-danger" type="submit"><i class="fa-solid fa-right-from-bracket"></i></button></a>
                            </div>
                        </div>
                    </div>
                </nav>
