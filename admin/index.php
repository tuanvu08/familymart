                        ...
                        <div class="row">
                            <div class="col-4">
                                <div id="list-example" class="list-group">
                                    ...
                                    <a class="list-group-item list-group-item-action" href="#list-item-2">Sản phẩm bán chạy</a>
                                    <a class="list-group-item list-group-item-action" href="#list-item-3">Thống kê doanh thu</a>
                            ...
                            <div class="col-8">
                                <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-smooth-scroll="true" class="scrollspy-example" tabindex="0">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        ?>
                                        <button type="button" class="btn btn-outline-success">Tổng doanh thu:<?= $doanhthu ?> (VNĐ) </button>
                                    </div>
                                    </p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <form class="py-3" method="post">
                                                <div class="row">
                                                    <div class="col-md-5"><input type="date" name="thoigiantc" id="thoigian"></div>
                                                    <div class="col-md-2"> <button type="submit" name="tracuuspbanchay" class="btn btn-primary"><i class="fa-solid fa-magnifying-glass"></i></button>
                                                    </div>
                                                </div>
                                            </form>
                                            <table class="table table-striped">
                                    ...
                                    <p>
                                        ...
                                        ?>
                                        <button type="button" class="btn btn-outline-success">Tổng doanh thu tháng <?= $thang ?> :<?= $doanhthuthang ?> (VNĐ) </button>
                                    <h4>Tra cứu doanh thu </h4>
                                    <form class="py-3" method="post">
                                        <div class="row">
                                            <div class="col-md-3"><input type="date" name="thoigian" id="thoigian"></div>
                                            <div class="col-md-1"> <button type="submit" name="tracuu" class="btn btn-primary"><i class="fa-solid fa-magnifying-glass"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                    <?php
                                    if (isset($_POST['tracuu'])) {
                                        ...
                                        <button type="button" class="btn btn-outline-warning">Doanh thu ngày <?= $thoigiantc ?> :<?= $doanhthutracuu ?> (VNĐ) </button>
                                    <?php
                                    }
                                    ?>
                                    ...
                                    <div class="row py-2">
                                        <div class="col-md-4">
                                            ...
                                            <button type="button" class="btn btn-outline-info">Liên hệ mới :<?= $sllh ?> </button>
                                        </div>
                                    </div>
                                    </p>
                                </div>
