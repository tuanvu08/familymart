            ...
            <div class="row py-3">
                ...
                ?>
                        ...
                        <form class="col-md-6 userForm" method="post">
                            <input type="hidden" class="form-control" id="tdc" name="tdc" value="<?php echo $row["tieude"]; ?>" required>
                            <div class="py-1">
                                <label>
                                ...
                                <div class="py-1">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="tieude" name="tieude" placeholder="" value="<?php echo $row["tieude"]; ?>" required>
                                        <label for="tieude">Tiêu đề :</label>
                                    </div>
                                </div>
                                <div class="py-1">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="nd" name="nd" placeholder="" value=" <?php echo $row["noidung"]; ?>" required>
                    ...
                    <div class="modal-body">
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="delete" name="xoasp" placeholder="<?= $sp ?>">
