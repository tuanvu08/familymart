        ...
        <div class="container h-5- w-50">
            <form method="post">
                <div class="container">
                    ...
                    <input type="password" minlength="6" id="password" placeholder="Nhập mật khẩu(mật khẩu phải có ít nhất 6 ký tự)" name="matkhau" required>

                    <label for="cfpw"><b>Nhập lại mật khẩu</b></label>
                    <input type="password" minlength="6" id="cfpassword" placeholder="Nhập lại mật khẩu" name="cfpw" required>

                    <label for="sdt"><b>Số điện thoại</b></label>
                    <input type="text2" id="sdt" minlength="10" maxlength="10" placeholder="Nhập số điện thoại (số điện thoại phải bắt đầu bằng số '0' và có 10 ký tự )" name="sdt" required>
