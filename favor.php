                            ...
                            <div class="col-md">
                                <div class="product-card">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h5><button type="button" class="btn btn-link" data-bs-toggle="modal" data-bs-target="#<?= $row["masp"] ?>"><?= $row["tensp"] ?></button></h5>
                                        <p><?= $row["ncc"] ?> </p>
                                        <div class="product-bottom-details">
                                            ...
                                            <div class="product-links">
                                                <form method="post" action="xuly.php">
                                                    ...
                                                    <div class="d-flex">
                                                        <button class="btn btn-link" style="width: 20px;" type="submit" name="delete"><i class="fa-solid fa-heart-crack"></i></button>
