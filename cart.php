        ...
        <div class="container py-3" style="height: 400px; overflow-y: auto;">
                ...
                <tbody>
                    ...
                    ?>
                                <tr>
                                    ...
                                    <td><?= $sp[4]; ?></td>
                                    <td><?= $sp[3]; ?></td>
                                    <td><?= $sp[5]; ?> <button type="button" class="btn btn btn-link" style="width: 20px;" data-bs-toggle="modal" data-bs-target="#a<?= $sp[0]; ?>"><i class="fa-regular fa-pen-to-square"></i></button> </td>
                                    <div class="modal fade" id="a<?= $sp[0]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST">
                                                        <div class="mb-3">
                                                            <input type="hidden" class="form-control" name="id" value="<?= $sp[0] ?>">
                                                            <label for="update" class="col-form-label">Số lượng hiện tại:<?= $sp[5] ?>- số lượng còn lại :
                                                                <?php
                                                                ...
                                                                ?></label>
                                                            <input type="number" class="form-control" id="update" name="update" placeholder="nhập số lượng mới" min="1" max="<?= $sl ?>">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <div class="col"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button></div>
                                                            <div class="col"><button type="submit" class="btn btn-success" name="updateSL">update</button></div>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                    ...
                                    <td> <?= $thanhtien ?> </td>
                                    <td style="width: 5%;">
                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#go<?= $sp[0]; ?>">Gỡ</button>
                                        <div class="modal fade" id="go<?= $sp[0]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Gỡ sản phẩm khỏi giỏ hàng</h1>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="delcart.php?id=<?= ($i - 1) ?>" method="POST">
                                                            ...
                                                            <div class="modal-footer">
                                                                <div class="col"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button></div>
                                                                <div class="col"><button type="submit" class="btn btn-danger" name="xoa">gỡ</button></div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="modal fade" id="boxthanhtoan" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form method="post">
                                    <div class="modal-header">
                                        ...
                                        ?>
                                                ...
                                                <div class="py-1">
                                                    ...
                                                    <div class="py-1">
                                                        ...
                                                        <div class="py-1">
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control" id="tennn" name="tennguoinhan" placeholder="" value="<?php echo $row["tennguoidung"]; ?>" required>
                                                                <label for="tennn">Tên người nhận :</label>
                                                            </div>
                                                        </div>
                                                        <div class="py-1">
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control" id="sdt" name="sdt" placeholder="" value="<?php echo $row["sdt"]; ?>" required>
                                                                <label for="sdt">Số điện thoại người nhận :</label>
                                                            </div>
                                                        </div>
                                                        <div class="py-1">
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control" id="diachi" name="diachi" placeholder="" value="<?php echo $row["diachi"]; ?>" required>
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <div class="col-py-1">
                                                                            <div class="form-floating mb-3">
                                                                                <input type="text" class="form-control" id="giatri" name="giatri" placeholder="" value="<?= $tongtien ?>">
                                                                    ...
                                                                    <td>
                                                                        <div class="col-py-1">
                                                                            <div class="form-floating mb-3">
                                                                                <input type="text" class="form-control" id="thoigian" name="thoigian" placeholder="" value="<?= date('Y-m-d'); ?>">
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="modal-footer">
                                                            <div class="col"> <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                                                            </div>
                                                            <div class="col"> <button type="submit" name="add" class="btn btn-primary">Thanh toán</button>
                                                            </div>
                                                        </div>
                                </form>
                            </div>
